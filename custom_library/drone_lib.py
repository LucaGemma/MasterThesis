...
mininum_distance = 0.8  # minimum distance from the target to consider the target reached
...
def arm_and_takeoff(tgt_altitude, vehicle, log_level=logging.INFO):  # add a third input param "interrupt"
...
def landing(vehicle, log_level=logging.INFO):
